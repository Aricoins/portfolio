...
const DraggableIcon = styled.div`
  ...
  border-radius: 6px;
  background: ${(props) =>
    props.matched ? "rgba(74, 222, 128, 0.2)" : "rgba(255,255,255,0.1)"};
  transition: all 0.3s ease;
  transform: ${(props) =>
    props.isDragging ? "scale(1.1) rotate(2deg)" : "scale(1)"};
  min-height: 35px;
  display: flex;
  align-items: center;
  justify-content: center;
...
const DropZone = styled.div`
  background: ${(props) =>
    props.isOver ? "rgba(74, 222, 128, 0.3)" : "rgba(255,255,255,0.1)"};
  border: 1px dashed
    ${(props) =>
