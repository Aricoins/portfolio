...
const Banner = () => {
  ...
  const scenes = [
    ...
    { text: 'IDEA', bgText: coloresBlack.cuarto, textColor: coloresBlack.segundo, bgColor: coloresBlack.primero, duration: 0.3 },
    { text: 'EMPRESA', bgText: coloresBlack.cuarto, textColor: coloresBlack.tercero, bgColor: coloresBlack.primero, duration: 0.3 },
